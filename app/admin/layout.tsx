...
const adminNavItems = [
  ...
  { name: "គ្រប់គ្រងគ្រូបង្រៀន", path: "/admin/users", icon: Users },
  { name: "វត្តមានគ្រូ", path: "/admin/teacher-attendance", icon: MapPin },
  { name: "គ្រប់គ្រងថ្នាក់រៀន", path: "#", icon: BookOpenCheck },
  { name: "របាយការណ៍សាលា", path: "#", icon: FileBarChart },
  { name: "សេចក្តីជូនដំណឹង", path: "#", icon: BellRing },
]
